...
const FileUploader = ({fieldChange, mediaUrl}: FileUploaderProps) => {
  ...
  return (
    <div {...getRootProps()} className='flex flex-center flex-col bg-gray-850 rounded-xl cursor-pointer'>
      <input {...getInputProps()} className='cursor-pointer'/>
      {
        fileUrl ? (
            ...
            <div className='file_uploader-box'>
                ...
                <p className='text-white small-regular mb-6'>SVG, PNG, JPG, JPEG</p>
